...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNPdftron/RNPdftron.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PDFNet/PDFNet.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PDFNet/Tools.framework"
fi
